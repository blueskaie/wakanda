                ...
                <div class="col-lg-8 col-md-8">
                    ...
                    <div class="post">
                        <div class="wrap-ut pull-left">
                            <div class="userinfo pull-left">
                                ...
                                <div class="icons">
                                    <img src="{{ asset('maintheme/images/icon1.jpg') }} " alt="" /><img src="{{ asset('maintheme/images/icon4.jpg') }} " alt="" />
                                </div>
                            </div>
                    ...
                    <div class="post">
                        <div class="wrap-ut pull-left">
                            <div class="userinfo pull-left">
                                ...
                                <div class="icons">
                                    <img src="{{ asset('maintheme/images/icon3.jpg') }} " alt="" /><img src="{{ asset('maintheme/images/icon4.jpg') }} " alt="" /><img src="{{ asset('maintheme/images/icon5.jpg') }} " alt="" /><img src="{{ asset('maintheme/images/icon6.jpg') }} " alt="" />
                                </div>
                            </div>
                            <div class="posttext pull-left">
                    ...
                    <div class="post">
                        <div class="wrap-ut pull-left">
                            <div class="userinfo pull-left">
                                <div class="avatar">
                                    <img src="{{ asset('maintheme/images/avatar3.jpg') }} " alt="" />
                                    <div class="status red">&nbsp;</div>
                                </div>

                                <div class="icons">
                                    <img src="{{ asset('maintheme/images/icon2.jpg') }} " alt="" /><img src="{{ asset('maintheme/images/icon4.jpg') }} " alt="" />
                                </div>
                            </div>
                            <div class="posttext pull-left">
                    ...
                    <div class="post">
                        <div class="wrap-ut pull-left">
                            <div class="userinfo pull-left">
                                <div class="avatar">
                                    <img src="{{ asset('maintheme/images/avatar4.jpg') }} " alt="" />
                                    <div class="status yellow">&nbsp;</div>
                                </div>

                                <div class="icons">
                                    <img src="{{ asset('maintheme/images/icon1.jpg') }} " alt="" /><img src="{{ asset('maintheme/images/icon4.jpg') }} " alt="" /><img src="{{ asset('maintheme/images/icon6.jpg') }} " alt="" />
                                </div>
                            </div>
                            <div class="posttext pull-left">
